...
Public Class cPerfil : Inherits cGeneracion

    Private dsEjecutivo As DataSet
    Private dsVariable As DataSet
    Private Const Reporte As String = "Reporte Perfil de la Flota"
    ...
    Public Overrides Sub Generar(Datos As Object)
        Console.WriteLine(Datos.usuarioId.ToString() & ": Obteniendo Datos para el Reporte Perfil")
