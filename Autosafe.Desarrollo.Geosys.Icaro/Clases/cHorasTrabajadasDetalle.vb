...
Public Class cHorasTrabajadasDetalle : Inherits cGeneracion

    Private dsHorasTrabajadas As DataSet
    Private Const Reporte As String = "Reporte de Detalle Horas Trabajadas de la Flota"
    ...
    Public Overrides Sub Generar(Datos As Object)
        Console.WriteLine(String.Format("{0}: Obteniendo Datos para el Reporte Detalle de Horas Trabajadas", Datos.usuarioId))
        ...
        Try
            ...
            For Each tActivo In lista
                Try
                    ...
                    '******************************************************************************
                    'Console.WriteLine("Obteniendo Detalle Horas Trabajadas de: " & tActivo.Alias)
                    Console.WriteLine(String.Format("Obteniendo Detalle Horas Trabajadas de:  {0} {1} {2}", tActivo.alias, Fecha2ANSI(Me.FechaInicial.ToString(), True), Fecha2ANSI(Me.FechaFinal.ToString(), True)))
                    '******************************************************************************
                    ...
                    Hoja.Header.Center = "Reporte Detalle de Horas Trabajadas"
                    ...
                    Try
                        dsHorasTrabajadas.Tables(0).Columns.Remove("MinutosH")
                    Catch ex As Exception
