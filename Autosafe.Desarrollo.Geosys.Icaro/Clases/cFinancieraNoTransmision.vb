...
Public Class cFinancieraNoTransmision : Inherits cGeneracion

    Private dsProtocolo As DataSet
    Private Const Reporte As String = "Reporte de Financiera No Transmision de la Flota"
    ...
    Public Overrides Sub Generar(Datos As Object)
        Console.WriteLine(Datos.usuarioId.ToString() & ": Obteniendo Datos para el Reporte Financiera No Transmision")
    ...
    Private Function GenerarReporte(ByVal IdUsuario As Integer,
        ...
        Try
            Hoja.Header.Center = "Reporte Financiera No Transmision Flota"
            ...
            Console.WriteLine(String.Format("Obteniendo Financiera No Transmision de la Flota: {0} {1}", Fecha2ANSI(Me.FechaInicial.ToString(), True), Fecha2ANSI(Me.FechaFinal.ToString(), True)))
            '******************************************************************************
            ...
            If (My.Settings.Pais = "PE") Then
                ...
                sql = String.Format("sp_financiera_no_transmision '{0}'",
                                    Me.IdEntidad
                               )
            Else
                sql = String.Format("[sp_maf_reporte_extranet] "
            ...
            Dim vnxls As New fFinancieraNoTransmisionGrid(dsProtocolo, Me.Archivo, CDbl(0))
            vnxls.GenerarArchivo()
