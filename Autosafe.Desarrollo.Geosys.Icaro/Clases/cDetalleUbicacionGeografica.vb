...
Public Class cDetalleUbicacionGeografica : Inherits cGeneracion

    Private dsCalidadManejo As DataSet
    Private Const Reporte As String = "Reporte de Detalle de Ubicacion Geografica de la Flota"
    ...
    Private Function GenerarReporte(ByVal IdUsuario As Integer,
        ...
        Try
            Hoja.Header.Center = "Reporte Resumen de Detalle de Ubicacion Geografica Flota"
            ...
            Console.WriteLine(String.Format("Obteniendo Detalle de Ubicacion Geografica de la Flota: {0} {1}", Fecha2ANSI(Me.FechaInicial.ToString(), True), Fecha2ANSI(Me.FechaFinal.ToString(), True)))
            '******************************************************************************
            ...
            If (My.Settings.Pais = "PE") Then
                sql = String.Format("spDetalleUbicacionFlota '{0}','{1} {2}'",
                           Me.IdUsuario,
            ...
            For Each TmpRow As DataRow In dsCalidadManejo.Tables(0).Rows
                ...
                Try
                    ...
                    TmpRow("Vid") = String.Format("http://maps.google.com/maps?q={0},{1}*{2}", TmpRow("Lat").ToString(), TmpRow("Lon").ToString(), TmpRow("Date_time").ToString())
            ...
            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Gps")
            Catch ex As Exception
            ...
            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Date_time")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Rumbo")
            Catch ex As Exception
            ...
            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Input_Event")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Evento")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("DEvento")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("S1")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("S2")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Horometro")
            Catch ex As Exception
                ...
                For Each dColum As DataColumn In dsCalidadManejo.Tables(0).Columns
                    ...
                    Select Case dColum.ColumnName.ToUpper()
                        ...
                        Case "IGNICION"
                            Celda.SetCellValue("IGNICION")
                        Case "KILOMETRAJE"
                            Celda.SetCellValue("ODOMETRO")
                        Case "PTOCERCANO"
                            Celda.SetCellValue("PTO. CERCANO")
                        Case "CALLE"
                            Celda.SetCellValue("CALLE / VIA / REFERENCIA")
                        Case Else
