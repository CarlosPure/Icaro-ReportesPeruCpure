...
Public Class cCuadroTrabajo : Inherits cGeneracion

    Private dsProtocolo As DataSet
    Private Const Reporte As String = "Reporte de Cuadro de Trabajo de la Flota"
    ...
    Public Overrides Sub Generar(Datos As Object)
        Console.WriteLine(Datos.usuarioId.ToString() & ": Obteniendo Datos para el Reporte Cuadro de Trabajo")
    ...
    Private Function GenerarReporte(ByVal IdUsuario As Integer,
        ...
        Try
            Hoja.Header.Center = "Reporte Cuadro de Trabajo Flota"
            ...
            Console.WriteLine(String.Format("Obteniendo Cuadro de Trabajo de la Flota: {0} {1}", Fecha2ANSI(Me.FechaInicial.ToString(), True), Fecha2ANSI(Me.FechaFinal.ToString(), True)))
            '******************************************************************************
            ...
            If (My.Settings.Pais = "PE") Then
                ...
                sql = String.Format("peru.sp_cuadro_trabajo '{0}'",
            ...
            Dim vnxls As New fCuadroTrabajoPeruGrid(dsProtocolo, Me.Archivo, CDbl(0))
            vnxls.GenerarArchivo()
