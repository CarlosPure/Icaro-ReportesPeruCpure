...
Public Class cCalidadManejo : Inherits cGeneracion

    Private dsCalidadManejo As DataSet
    Private Const Reporte As String = "Reporte de Resumen de Calidad de Manejo de la Flota"
    ...
    Public Overrides Sub Generar(Datos As Object)
        Console.WriteLine(Datos.usuarioId.ToString() & ": Obteniendo Datos para el Reporte de Resumen de Calidad de Manejo")
    ...
    Private Function GenerarReporte(ByVal IdUsuario As Integer,
        ...
        Try
            Hoja.Header.Center = "Reporte Resumen de Calidad de Manejo Flota"
            ...
            Console.WriteLine(String.Format("Obteniendo Resumen de Calidad de Manejo de la Flota: {0} {1}", Fecha2ANSI(Me.FechaInicial.ToString(), True), Fecha2ANSI(Me.FechaFinal.ToString(), True)))
            '******************************************************************************
            ...
            If (My.Settings.Pais = "PE") Then
                sql = String.Format("SP_PDF_ResumenEjecutivoIcaro '{0}','{1}','{2}','{3}'",
                           Me.IdEntidad,
            ...
            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Inicio")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Fin")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Velocidad Limite (Km/h)")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Distancia")
            Catch ex As Exception

            End Try

            Try
                dsCalidadManejo.Tables(0).Columns.Remove("Dias Usados")
            Catch ex As Exception
            ...
            If TotalRegistros < My.Settings.TotalRegistrosMaximo Then
                ...
                Console.WriteLine(Hoja.LastRowNum + 1)
