...
Public Class cGestionRiesgo : Inherits cGeneracion

    Private dsProtocolo As DataSet
    Private Const Reporte As String = "Reporte de Gestion de Riesgo de la Flota"
    ...
    Public Overrides Sub Generar(Datos As Object)
        Console.WriteLine(Datos.usuarioId.ToString() & ": Obteniendo Datos para el Reporte Gestion de Riesgo")
    ...
    Private Function GenerarReporte(ByVal IdUsuario As Integer,
        ...
        Try
            Hoja.Header.Center = "Reporte Gestion de Riesgo Flota"
            ...
            Console.WriteLine(String.Format("Obteniendo Gestion de Riesgo de la Flota: {0} {1}", Fecha2ANSI(Me.FechaInicial.ToString(), True), Fecha2ANSI(Me.FechaFinal.ToString(), True)))
            '******************************************************************************
            ...
            If (My.Settings.Pais = "PE") Then
                ...
                sql = String.Format("spMafReporteExtranet '{0}','{1}'",
                               Me.IdEntidad,
            ...
            Dim vnxls As New fMafGrid(dsProtocolo, Me.Archivo, CDbl(0))
            vnxls.GenerarArchivo()
