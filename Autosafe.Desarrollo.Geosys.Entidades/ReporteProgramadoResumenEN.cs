...
{
    public class ReporteProgramadoResumenEN : BaseEN
    {
        public readonly string Table_Name = "ReporteProgramadoResumenEN";
        ...
        public int totalMalos { get; set; }
               

        public ReporteProgramadoResumenEN() { }
        public ReporteProgramadoResumenEN(IDataReader Registro, int tipo)
        {
            try
            {
                switch (tipo)
