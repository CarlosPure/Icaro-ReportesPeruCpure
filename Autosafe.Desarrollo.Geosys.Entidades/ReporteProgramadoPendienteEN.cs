...
{
    public class ReporteProgramadoPendienteEN : BaseEN
    {
        public readonly string Table_Name = "ReporteProgramadoPendienteEN";
        ...
        public ReporteProgramadoPendienteEN() { }
        public ReporteProgramadoPendienteEN(IDataReader Registro, int tipo)
        {
            try
            {
                switch (tipo)
                {
                    ...
                    case 1:
                        ...
                        //activos = ValidarString(Registro["Activos"]);
                        secuencia = ValidarInt(Registro["Secuencia"]);
                        //horas = ValidarInt(Registro["CuentaForzarSI"]);
                        //guardar = ValidarBool(Registro["Guardar"]);
                        //forzar = ValidarBool(Registro["Forzar"]);
                        //nombre = ValidarString(Registro["Nombre"]);
                        horaInicio = ValidarString(Registro["FechaInicial"]);
                        horaFin = ValidarString(Registro["FechaFinal"]);
                        errorEnvio = ValidarString(Registro["ErrorEnvio"]);
                        horas = ValidarInt(Registro["CuentaForzarSI"]);
                        estadoId = ValidarInt(Registro["CuentaForzarNO"]);
                        break;
